...
"""
this script runs a parallelized parameter sweep with no cloud longwave effects (β = 0) 
...
try
    ...
    ps = setupparams4sweep_Πonly(nsamp,log_min_Π1_search,log_max_Π1_search,log_min_Π2_search,log_max_Π2_search,
